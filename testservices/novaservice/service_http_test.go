...
var _ = gc.Suite(&NovaHTTPSuite{useNeutronNetworking: true})
...
var _ = gc.Suite(&NovaHTTPSSuite{HTTPSuite: httpsuite.HTTPSuite{UseTLS: true}, useNeutronNetworking: false})
...
func (s *NovaHTTPSuite) TestSimpleRequestTests(c *gc.C) {
	s.runSimpleRequestTests(c, s.simpleTests())
	if !s.useNeutronNetworking {
