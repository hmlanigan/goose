...
func New() *NeutronModel {
	...
	defaultNetworks := []neutron.NetworkV2{
		{Id: "999", Name: "private_999", SubnetIds: []string{"999-01"}, External: false},
		{Id: "998", Name: "public_998", SubnetIds: []string{"998-01"}, External: true},
		{Id: "997", Name: "public_997", SubnetIds: []string{"997-01"}, External: true},
	}
...
func (n *NeutronModel) NovaSecurityGroupByName(groupName string) (*nova.SecurityGroup, error) {
	group, err := n.SecurityGroupByName(groupName)
	if err != nil {
		return nil, err
	}
	novaGroup := n.convertNeutronToNovaSecurityGroup(*group)
